...
<%
 ...
 %>
        <c:set var="clientId" value="<%=xssFilterWrap(xssAPI, props.get("oauth.client.id"))%>" />

        <li><div class="li-bullet"><strong><%= i18n.get("App ID/API Key:") %></strong><%=xssFilterWrap(xssAPI, props.get("oauth.client.id"))%></div></li>


        <li>
            <div class="li-bullet"><strong><%= i18n.get("Create Users:") %></strong>
               <%=xssFilterWrap(xssAPI, props.get("oauth.create.users"))%>
            </div>
        </li>

        <li>
            <div class="li-bullet"><strong><%= i18n.get("Mask User Ids:") %></strong>
                <%=xssFilterWrap(xssAPI, props.get("oauth.encode.userids"))%>
            </div>
        </li>
        ...
        <%
            ...
            %>
                ...
                <li>
                    <div class="li-bullet">
                        <div class="fbconnect-div-comma-sep-list">
                        <strong><%= i18n.get("User Permissions:") %></strong><%=xssFilterWrap(xssAPI, userSb.toString())%>
                        </div>
                    </div>
                </li>
                <% } %>
                ...
                <li>
                    <div class="li-bullet">
                        <div class="fbconnect-div-comma-sep-list">
                        <strong><%= i18n.get("Friend Permissions:") %></strong><%=xssFilterWrap(xssAPI, friendSb.toString())%>
                        </div>
                    </div>
                </li>
                <% } %>
                ...
                <li>
                    <div class="li-bullet">
                        <div class="fbconnect-div-comma-sep-list">
                        <strong><%= i18n.get("Extended Permissions:") %></strong><%=xssFilterWrap(xssAPI, extSb.toString())%>
                        </div>
                    </div>
                </li>
                <% } %>
                ...
                <li>
                    <div class="li-bullet">
                        <div class="fbconnect-div-comma-sep-list">
                        <strong><%= i18n.get("URL Parameters:") %></strong><%=xssFilterWrap(xssAPI, urlparams.toString())%>
                        </div>
                    </div>
                </li>
                <% } %>
            <% } %>
            <li class="when-config-successful" style="display:none;">Gmail Connect Configuration is successful.</li>
        <% }else{ %>
