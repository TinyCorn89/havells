...
package apps.havells.components.commerce.product.image;
 ...
 */
public class banner_GET extends AbstractImageServlet {

    /**
     * destination width
     */
    private final static int D_WIDTH = 146;

    /**
     * destination height
     */
    private final static int D_HEIGHT = 154;
    ...
    protected Layer createLayer(ImageContext c) throws RepositoryException, IOException {
        ...
        if (newSize.width < D_WIDTH) {
            ...
            // Center vertically to the upper half
            layer.setY((D_HEIGHT - newSize.height) / 4);
        }
