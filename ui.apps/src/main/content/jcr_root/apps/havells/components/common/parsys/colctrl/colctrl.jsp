...
<%
    ...
    String verticalBorder = (String)map.get("borderVertical");
    String horizontalBorder = (String)map.get("horizontalVertical");
%>

<script>
    $(document).ready(function(){
        jQuery().renderColCtrl("<%=verticalBorder%>","<%=horizontalBorder%>");
        console.log("Called")
    });

    ;(function($){
        $.fn.renderColCtrl = function(verticalBorder , horizontalBorder){
            console.log("verti" , verticalBorder);
            console.log("verti" , horizontalBorder);

            $('.cq-colctrl-lt0 .cq-colctrl-lt0-c0 > *').addClass(verticalBorder);
            console.log("Done");
        }
